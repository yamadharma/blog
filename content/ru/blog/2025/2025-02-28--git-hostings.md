...
lastmod: 2025-03-13T10:50:00+03:00
draft: false
slug: "git-hostings"
---
...
## <span class="section-num">1</span> Глобальные хостинги {#глобальные-хостинги}


### <span class="section-num">1.1</span> GitHub {#github}
...
### <span class="section-num">1.2</span> GitLab {#gitlab}
...
### <span class="section-num">1.3</span> Bitbucket {#bitbucket}
...
### <span class="section-num">1.4</span> Azure Repos {#azure-repos}
...
## <span class="section-num">2</span> Российские хостинги {#российские-хостинги}


### <span class="section-num">2.1</span> GitFlic {#gitflic}
...
### <span class="section-num">2.2</span> SourceCraft {#sourcecraft}

-   Сайт: <https://sourcecraft.dev>
-   Попытка сделать что-то более прродвинутое, чем github.
-   Сервис от Яндекс.
...
## <span class="section-num">3</span> Местечковые репозитории {#местечковые-репозитории}


### <span class="section-num">3.1</span> Codeberg {#codeberg}
...
## <span class="section-num">4</span> Рекомендации по выбору {#рекомендации-по-выбору}
