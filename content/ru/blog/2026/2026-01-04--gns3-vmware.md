...
-   Будем использовать Chocolatey ([Пакетный менеджер для Windows. Chocolatey]({{< relref "../notes/public/20210118112300-пакетныи_менеджер_для_windows_chocolatey.md" >}})).
-   Установим vmWare (см. [Система виртуализации VMware]({{< relref "../notes/public/20240516113300-система_виртуализации_vmware.md" >}})):
    ```shell
