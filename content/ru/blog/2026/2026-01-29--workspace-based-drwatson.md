...
lastmod: 2026-01-29T18:01:00+03:00
draft: false
...
## <span class="section-num">3</span> Реализация гибридного подхода {#реализация-гибридного-подхода}


### <span class="section-num">3.1</span> Создание метапроекта и первой лабораторной работы {#создание-метапроекта-и-первой-лабораторной-работы}
...
### <span class="section-num">3.2</span> Скрипт для управления всеми работами `run_all_labs.jl` {#скрипт-для-управления-всеми-работами-run-all-labs-dot-jl}
...
### <span class="section-num">3.3</span> Стандартизация структуры каждой лабораторной {#стандартизация-структуры-каждой-лабораторной}
...
### <span class="section-num">3.4</span> Шаблон для быстрого создания новых лабораторных {#шаблон-для-быстрого-создания-новых-лабораторных}
...
## <span class="section-num">4</span> Пошаговое руководство для учебного курса {#пошаговое-руководство-для-учебного-курса}


### <span class="section-num">4.1</span> Для студентов (сдача отдельных работ) {#для-студентов--сдача-отдельных-работ}
...
### <span class="section-num">4.2</span> Для преподавателей (управление всем курсом) {#для-преподавателей--управление-всем-курсом}
