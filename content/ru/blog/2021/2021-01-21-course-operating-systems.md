...
lastmod: 2025-12-23T17:27:00+03:00
tags: ["education"]
...
-   [Операционные системы. Лабораторные работы. Методические замечания]({{< relref "20221227142500-операционные_системы_лабораторные_работы_методические_замечания.md" >}})
...
2.  Системы контроля версий
    ...
    -   В качестве системы контроля используется _git_ (см. [Система контроля версий git]({{< relref "20201207154700-система_контроля_версии_git.md" >}})).
    -   Студентам даётся конкретный сценарий работы с _git_ на основе git-flow и общепринятых коммитов (см. [Практический сценарий использования git]({{< relref "20210117200600-практическии_сценарии_использования_git.md" >}})).
    -   Результат.
        -   Умения.
...
3.  Протоколирование выполнения лабораторной работы
    ...
    -   Выполнение лабораторной работы записывается в виде скринкаста (см. [Видеозапись самостоятельной работы]({{< relref "20210125165500-видеозапись_самостоятельнои_работы.md" >}})).
    ...
    -   Ожидается, что студент будет комментировать свои действия.
        ...
        -   Студент повышает свой уровень погружения в материал (в соответствии с таксономией Блума) (см. [Таксономия Блума]({{< relref "20210324122700-таксономия_блума.md" >}})).
...
1.  Установка операционной системы
    ...
    -   Дома они могут установить Linux:
        ...
        -   на флешку;
        -   на железо.
    -   Стоит только вопрос с выбором конкретного дистрибутива (см. [Выбор дистрибутива Linux]({{< relref "20210808112000-выбор_дистрибутива_linux.md" >}})).
    -   Результат.
        -   Умения.
...
-   [Лабораторная работа Установка ОС Linux]({{< relref "20220404134000-лабораторная_работа_установка_ос_linux.md" >}})
...
-   Ключ ssh (см. [Ключи ssh]({{< relref "20220217145300-ключи_ssh.md" >}})).
-   Ключи pgp (см. [Верификация коммитов git с помощью GPG]({{< relref "20210128184700-верификация_коммитов_git_с_помощью_gpg.md" >}})).
-   Настройка рабочего каталога пользователя (см. [Рабочее пространство для лабораторной работы]({{< relref "20210116125100-рабочее_пространство_для_лабораторнои_работы.md" >}})).


#### <span class="section-num">5.2.3</span> Настройка рабочей среды {#настройка-рабочей-среды}

-   [Лабораторная работа Настройка рабочей среды]({{< relref "20230730152500-лабораторная_работа_настроика_рабочеи_среды.md" >}})
-   Установка и настройка тайлового менеджера окон: i3wm (см. [Window manager i3]({{< relref "20210514113200-window_manager_i3.md" >}})) или sway (см. [Переход на Sway]({{< relref "20210410175400-переход_на_sway.md" >}})).
...
-   [Учебный проект Сайт научника]({{< relref "20220405182000-учебныи_проект_саит_научника.md" >}})
...
-   В качестве ответа на лабораторную работу необходимо представить:
    ...
    7.  Ссылка на проект на собственном сайте научно-инженерного работника (см. [Учебный проект Сайт научника]({{< relref "20220405182000-учебныи_проект_саит_научника.md" >}})), оформленная в виде проекта с подробным описанием прохождения.
    8.  Итого:
        -   приложить 7 файлов;
...
-   [Критериальное оценивание лабораторных работ]({{< relref "20201012095700-категориальное.md" >}})
-   [Критериальное оценивание докладов]({{< relref "20201208090600-критериальное_оценивание_докладов.md" >}})
...
-   [Порядок переаттестации]({{< relref "20251223T163000--порядок_переаттестации.md" >}})
