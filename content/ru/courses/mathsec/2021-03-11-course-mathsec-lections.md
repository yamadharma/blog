...
lastmod: 2021-04-05T18:46:00+03:00
tags: ["education"]
...
## <span class="section-num">3</span> Сценарный план лекций {#сценарный-план-лекций}


### <span class="section-num">3.1</span> Лекция № 1 {#лекция-1}
...
#### <span class="section-num">3.1.1</span> Установочная лекция {#установочная-лекция}
...
#### <span class="section-num">3.1.2</span> Основные понятия информационной безопасности {#основные-понятия-информационной-безопасности}
