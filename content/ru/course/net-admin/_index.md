...
lastmod: 2024-01-17T10:24:00+03:00
...
## <span class="section-num">1</span> Информация по курсу {#информация-по-курсу}
...
-   Активности
    ...
    -   А1.2: Лабораторные работы. Защита.
    -   А2: Доклады по темам.
...
### <span class="section-num">4.1</span> Темы лабораторных работ {#темы-лабораторных-работ}
...
## <span class="section-num">5</span> Доклады {#доклады}


### <span class="section-num">5.1</span> Темы докладов {#темы-докладов}


#### <span class="section-num">5.1.1</span> Моделирование сетей передачи данных {#моделирование-сетей-передачи-данных}
...
#### <span class="section-num">5.1.2</span> Основы сетевых технологий {#основы-сетевых-технологий}
...
#### <span class="section-num">5.1.3</span> Стандарты локальный сетей {#стандарты-локальный-сетей}
...
#### <span class="section-num">5.1.4</span> Настройка сетевого оборудования {#настройка-сетевого-оборудования}
...
#### <span class="section-num">5.1.5</span> Технологии канального уровня {#технологии-канального-уровня}
...
#### <span class="section-num">5.1.6</span> Технологии сетевого уровня {#технологии-сетевого-уровня}
...
#### <span class="section-num">5.1.7</span> Принципы управления сетями {#принципы-управления-сетями}
