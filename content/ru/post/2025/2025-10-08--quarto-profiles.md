...
## <span class="section-num">3</span> Пример использования профилей для создания многоязычного сайта {#пример-использования-профилей-для-создания-многоязычного-сайта}
