...
lastmod: 2024-01-21T18:28:00+03:00
tags: ["education"]
...
#### <span class="section-num">5.5.6</span> Критерии оценки {#критерии-оценки}
...
## <span class="section-num">6</span> Пересдача {#пересдача}


### <span class="section-num">6.1</span> Порядок сдачи {#порядок-сдачи}
...
#### <span class="section-num">6.1.1</span> Лабораторные работы {#лабораторные-работы}
...
#### <span class="section-num">6.1.2</span> Индивидуальный проект {#индивидуальный-проект}
