...
## <span class="section-num">4</span> Знания, умения, навыки {#знания-умения-навыки}
...
### <span class="section-num">4.1</span> Навыки работы с компьютером {#навыки-работы-с-компьютером}


#### <span class="section-num">4.1.1</span> Основные навыки {#основные-навыки}
...
#### <span class="section-num">4.1.2</span> Системы контроля версий {#системы-контроля-версий}
...
#### <span class="section-num">4.1.3</span> Протоколирование выполнения лабораторной работы {#протоколирование-выполнения-лабораторной-работы}
...
#### <span class="section-num">4.1.4</span> Markdown {#markdown}
...
### <span class="section-num">4.2</span> Умения работы с компьютером {#умения-работы-с-компьютером}


#### <span class="section-num">4.2.1</span> Установка операционной системы {#установка-операционной-системы}
...
### <span class="section-num">4.3</span> Знания работы с компьютером {#знания-работы-с-компьютером}


### <span class="section-num">4.4</span> Уровень владения {#уровень-владения}
...
## <span class="section-num">5</span> Лабораторные работы по курсу Операционным системам {#лабораторные-работы-по-курсу-операционным-системам}
...
### <span class="section-num">5.3</span> Настройка рабочей среды {#настройка-рабочей-среды}

-   Установка и настройка i3wm


### <span class="section-num">5.4</span> Работа в git {#работа-в-git}
...
### <span class="section-num">5.5</span> Emacs {#emacs}

-   Установка emacs
-   Настройка emacs


### <span class="section-num">5.6</span> Подготовка отчётов {#подготовка-отчётов}
...
### <span class="section-num">5.7</span> Подготовка презентаций {#подготовка-презентаций}
...
### <span class="section-num">5.8</span> Работа с базой библиографии {#работа-с-базой-библиографии}

-   Создание базы библиографии
-   Добавление в базу новых публикаций


### <span class="section-num">5.9</span> Добавление библиографии в текст {#добавление-библиографии-в-текст}
...
### <span class="section-num">5.10</span> Обслуживание домашнего каталога {#обслуживание-домашнего-каталога}
...
### <span class="section-num">5.11</span> Регулярные выражения {#регулярные-выражения}


### <span class="section-num">5.12</span> Работа с паролями {#работа-с-паролями}
...
## <span class="section-num">6</span> Проекты {#проекты}


### <span class="section-num">6.1</span> Индивидуальный проект _Персональный сайт научного работника_ {#индивидуальный-проект-персональный-сайт-научного-работника}
