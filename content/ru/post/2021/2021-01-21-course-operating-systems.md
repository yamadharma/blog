...
lastmod: 2022-06-06T11:40:00+03:00
tags: ["education"]
...
### <span class="section-num">5.2</span> Доклады {#доклады}

-   Доклады сгруппированы по темам лекций.


#### <span class="section-num">5.2.1</span> Введение в операционную систему UNIX {#введение-в-операционную-систему-unix}
...
#### <span class="section-num">5.2.2</span> Архитектура UNIX. Файлы и устройства {#архитектура-unix-dot-файлы-и-устройства}
...
#### <span class="section-num">5.2.3</span> Архитектура UNIX. Процессы {#архитектура-unix-dot-процессы}
...
#### <span class="section-num">5.2.4</span> Терминал и командная строка {#терминал-и-командная-строка}
...
#### <span class="section-num">5.2.5</span> Введение в безопасность UNIX {#введение-в-безопасность-unix}
...
#### <span class="section-num">5.2.6</span> Сеть в UNIX {#сеть-в-unix}
...
#### <span class="section-num">5.2.7</span> Управление службами {#управление-службами}
...
#### <span class="section-num">5.2.8</span> Управление программным обеспечением {#управление-программным-обеспечением}
...
### <span class="section-num">5.3</span> Лабораторные работы {#лабораторные-работы}


#### <span class="section-num">5.3.1</span> Установка ОС Linux {#установка-ос-linux}
...
#### <span class="section-num">5.3.2</span> Первоначальна настройка git {#первоначальна-настройка-git}
...
#### <span class="section-num">5.3.3</span> Настройка рабочей среды {#настройка-рабочей-среды}

-   Установка и настройка i3wm


#### <span class="section-num">5.3.4</span> Работа в git {#работа-в-git}
...
#### <span class="section-num">5.3.5</span> Emacs {#emacs}

-   Установка emacs
-   Настройка emacs


#### <span class="section-num">5.3.6</span> Подготовка отчётов {#подготовка-отчётов}
...
#### <span class="section-num">5.3.7</span> Подготовка презентаций {#подготовка-презентаций}
...
#### <span class="section-num">5.3.8</span> Работа с базой библиографии {#работа-с-базой-библиографии}

-   Создание базы библиографии
-   Добавление в базу новых публикаций


#### <span class="section-num">5.3.9</span> Добавление библиографии в текст {#добавление-библиографии-в-текст}
...
#### <span class="section-num">5.3.10</span> Обслуживание домашнего каталога {#обслуживание-домашнего-каталога}
...
#### <span class="section-num">5.3.11</span> Регулярные выражения {#регулярные-выражения}


#### <span class="section-num">5.3.12</span> Работа с паролями {#работа-с-паролями}
