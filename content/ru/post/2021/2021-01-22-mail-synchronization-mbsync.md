...
## <span class="section-num">5</span> Перенос почтовых файлов {#перенос-почтовых-файлов}
...
## <span class="section-num">6</span> Технические моменты {#технические-моменты}


### <span class="section-num">6.1</span> Имена почтовых файлов {#имена-почтовых-файлов}
