...
lastmod: 2024-01-27T20:05:00+03:00
...
### <span class="section-num">5.1</span> Методика {#методика}


#### <span class="section-num">5.1.1</span> Выполнение проекта {#выполнение-проекта}

-   Проект выполняется в рамках малых групп (до 4 человек).


#### <span class="section-num">5.1.2</span> Представление проекта {#представление-проекта}
...
#### <span class="section-num">5.1.3</span> Этапы представления проекта {#этапы-представления-проекта}
...
### <span class="section-num">5.2</span> Темы групповых проектов {#темы-групповых-проектов}
...
#### <span class="section-num">6.1.1</span> Разные модели {#разные-модели}
...
#### <span class="section-num">6.1.2</span> Модельные подходы {#модельные-подходы}
