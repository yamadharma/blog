...
lastmod: 2023-03-13T11:59:00+03:00
...
Какие должны быть дисциплины при подготовке специалистов по _кибербезопасности_.
...
### <span class="section-num">4.1</span> Предметы {#предметы}


#### <span class="section-num">4.1.1</span> Математика {#математика}
...
### <span class="section-num">4.2</span> Обязательная часть {#обязательная-часть}


#### <span class="section-num">4.2.1</span> Базовая компонента {#базовая-компонента}
...
#### <span class="section-num">4.2.2</span> Вариативная компонента {#вариативная-компонента}
