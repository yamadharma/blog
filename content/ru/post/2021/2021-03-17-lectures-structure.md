...
lastmod: 2021-03-17T19:14:00+03:00
tags: ["education"]
categories: ["сиянс"]
draft: false
...
## <span class="section-num">2</span> Классификация лекционных занятий {#классификация-лекционных-занятий}
...
### <span class="section-num">2.1</span> Вводная лекция {#вводная-лекция}
...
### <span class="section-num">2.2</span> Информационная лекция {#информационная-лекция}
...
### <span class="section-num">2.3</span> Заключительная лекция {#заключительная-лекция}

Предназначена для обобщения полученных знаний и раскрытия перспектив дальнейшего развития данной науки.


### <span class="section-num">2.4</span> Обзорная лекция {#обзорная-лекция}
...
### <span class="section-num">2.5</span> Проблемная лекция {#проблемная-лекция}
...
### <span class="section-num">2.6</span> Лекция-визуализация {#лекция-визуализация}
...
### <span class="section-num">2.7</span> Лекция-конференция {#лекция-конференция}
...
### <span class="section-num">2.8</span> Лекция вдвоём (бинарная лекция) {#лекция-вдвоём--бинарная-лекция}
...
### <span class="section-num">2.9</span> Лекция с заранее запланированными ошибками {#лекция-с-заранее-запланированными-ошибками}
...
### <span class="section-num">2.10</span> Лекция-консультация {#лекция-консультация}
...
## <span class="section-num">3</span> Структура лекции {#структура-лекции}


### <span class="section-num">3.1</span> Вводная часть {#вводная-часть}
...
### <span class="section-num">3.3</span> Заключительная часть {#заключительная-часть}
...
## <span class="section-num">4</span> Функции лекции {#функции-лекции}


### <span class="section-num">4.1</span> Информационная функция {#информационная-функция}
...
### <span class="section-num">4.2</span> Стимулирующая функция {#стимулирующая-функция}
...
### <span class="section-num">4.3</span> Развивающая функция {#развивающая-функция}
...
### <span class="section-num">4.4</span> Ориентирующая функция {#ориентирующая-функция}
...
### <span class="section-num">4.5</span> Разъясняющая функция {#разъясняющая-функция}
...
### <span class="section-num">4.6</span> Убеждающая функция {#убеждающая-функция}
