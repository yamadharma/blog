...
lastmod: 2024-04-18T18:36:00+03:00
tags: ["sysadmin"]
...
## <span class="section-num">2</span> Гаджеты {#гаджеты}
...
## <span class="section-num">3</span> Графическое окружение {#графическое-окружение}
...
### <span class="section-num">3.1</span> X11 {#x11}


### <span class="section-num">3.2</span> Wayland {#wayland}
...
## <span class="section-num">4</span> Операционные системы {#операционные-системы}
...
### <span class="section-num">4.3</span> Установка операционных систем {#установка-операционных-систем}
...
### <span class="section-num">4.4</span> Серверные системы {#серверные-системы}
...
### <span class="section-num">4.5</span> Управление программным обеспечением {#управление-программным-обеспечением}

-   [Обновление пакетов python]({{< relref "2022-01-21-update-all-python-packages" >}})


### <span class="section-num">4.6</span> Терминальный доступ {#терминальный-доступ}

-   [Virtual Desktop Infrastructure]({{< relref "2022-07-23-virtual-desktop-infrastructure" >}})


### <span class="section-num">4.7</span> Утилиты настройки среды {#утилиты-настройки-среды}

-   [Утилита module]({{< relref "2022-07-24-module-utility" >}})


### <span class="section-num">4.8</span> Загрузчики {#загрузчики}

-   [Загрузчик rEFInd]({{< relref "2024-01-29-refind-boot-manager" >}})


## <span class="section-num">5</span> Файловые системы {#файловые-системы}


### <span class="section-num">5.1</span> Локальные файловые системы {#локальные-файловые-системы}
...
### <span class="section-num">5.2</span> Сетевые и распределённые файловые системы {#сетевые-и-распределённые-файловые-системы}

-   [Файловая система afs]({{< relref "2023-08-28-file-system-afs" >}})


### <span class="section-num">5.3</span> Файловые системы объединения (union) {#файловые-системы-объединения--union}

-   [Файловая система mergerfs]({{< relref "2024-01-28-mergerfs" >}})


## <span class="section-num">6</span> Форматы файлов {#форматы-файлов}


### <span class="section-num">6.1</span> csv {#csv}

-   [Формат CSV. csvkit]({{< relref "2023-07-06-csv-csvkit" >}})


## <span class="section-num">7</span> Языки программирования {#языки-программирования}

-   [Язык программирования HCL]({{< relref "2022-11-05-hcl-programming-language" >}})


## <span class="section-num">8</span> Разработка {#разработка}

-   [Обновление хостовых ключей ssh Bitbucket Cloud]({{< relref "2023-06-14-update-bitbucket-ssh-host-keys" >}})


## <span class="section-num">9</span> Серверы приложений {#серверы-приложений}


### <span class="section-num">9.1</span> Drupal {#drupal}

-   [Перенос Drupal на другую машину]({{< relref "2022-09-13-move-drupal-other-machine" >}})


### <span class="section-num">9.2</span> OJS {#ojs}

-   [Open Journal Systems]({{< relref "2022-10-22-open-journal-systems" >}})


### <span class="section-num">9.3</span> Ldap {#ldap}
...
### <span class="section-num">9.4</span> Kerberos {#kerberos}

-   [Перенос kerberos на другую машину]({{< relref "2023-09-03-kerberos-migration" >}})


### <span class="section-num">9.5</span> Git {#git}

-   [Хостинг git. gitea]({{< relref "2023-10-29-git-hosting-gitea" >}})


## <span class="section-num">10</span> Управление и мониторинг {#управление-и-мониторинг}

-   [Web консоль Cockpit]({{< relref "2022-01-18-cockpit-web-console" >}})


## <span class="section-num">11</span> Шрифты {#шрифты}

-   [Шрифты в Linux]({{< relref "2021-10-27-linux-fonts" >}})


## <span class="section-num">12</span> Пользовательские программы {#пользовательские-программы}


### <span class="section-num">12.1</span> Работа с файлами {#работа-с-файлами}

-   [Файловый менеджер Midnight Commander]({{< relref "2023-08-26-midnight-commander-file-manager" >}})


### <span class="section-num">12.2</span> Работа с терминалом {#работа-с-терминалом}
...
### <span class="section-num">12.3</span> Утилиты {#утилиты}
...
### <span class="section-num">12.4</span> Обработка видео {#обработка-видео}
...
### <span class="section-num">12.5</span> Виртуализация {#виртуализация}

-   [Система виртуализации VirtualBox]({{< relref "2021-09-17-virtualbox-virtualization-system" >}})


### <span class="section-num">12.6</span> Редакторы {#редакторы}

-   [Emacs]({{< relref "2020-12-24-emacs" >}})
-   [Редактор vim]({{< relref "2023-07-04-vim-editor" >}})


### <span class="section-num">12.7</span> Офисные программы {#офисные-программы}
...
### <span class="section-num">12.8</span> Работа с дисками {#работа-с-дисками}

-   [Использование sfdisk]({{< relref "2022-03-08-using-sfdisk" >}})


### <span class="section-num">12.9</span> Вычисления {#вычисления}
...
### <span class="section-num">12.10</span> Квантовая химия {#квантовая-химия}

-   [Квантовая химия. Gamess]({{< relref "2022-10-17-quantum-chemistry-gamess" >}})


### <span class="section-num">12.11</span> Синхронизация файлов {#синхронизация-файлов}

-   [rclone]({{< relref "2022-10-27-rclone" >}})
-   [Синхронизация файлов с помощью syncthing]({{< relref "2021-08-01-synchronizing-files-syncthing" >}})


### <span class="section-num">12.12</span> Файлы конфигурации {#файлы-конфигурации}
...
### <span class="section-num">12.13</span> Сетевые клиенты {#сетевые-клиенты}

-   [Флаги запуска google chrome]({{< relref "2023-02-28-google-chrome-flags" >}})
-   [Броузер Nyxt]({{< relref "2023-10-05-nyxt-browser" >}})


### <span class="section-num">12.14</span> Телеконференции {#телеконференции}

-   [Аналоги программ для видеоконференций]({{< relref "2023-03-23-video-conferencing-software-analogues" >}})


### <span class="section-num">12.15</span> Наборы программ {#наборы-программ}

-   [Программы на Android]({{< relref "2023-06-26-android-apps" >}})


### <span class="section-num">12.16</span> Просмотрщики {#просмотрщики}

-   [Pdf. Просмотр. Zathura]({{< relref "2023-09-20-pdf-viewer-zathura" >}})


## <span class="section-num">13</span> Конфигурации {#конфигурации}

-   [Моя конфигурация программного обеспечения]({{< relref "2024-03-06-my-software-configuration" >}})


## <span class="section-num">14</span> Безопасность {#безопасность}


### <span class="section-num">14.1</span> Пароли {#пароли}
...
### <span class="section-num">14.2</span> Разное {#разное}
...
### <span class="section-num">15.1</span> Cisco {#cisco}

-   [Администрирование Cisco]({{< relref "2021-06-16-cisco-administration" >}})


### <span class="section-num">15.2</span> Коммутаторы {#коммутаторы}

-   [DHCP snooping]({{< relref "2023-09-05-dhcp-snooping" >}})


### <span class="section-num">15.3</span> Протоколы {#протоколы}

-   [Протокол IPv6]({{< relref "2023-06-26-ipv6-protocol" >}})


#### <span class="section-num">15.3.1</span> Bittorrent {#bittorrent}

-   [bittorrent. Трекер opentracker]({{< relref "2024-01-31-bittorrent-opentracker" >}})


### <span class="section-num">15.4</span> VPN {#vpn}
...
### <span class="section-num">15.5</span> Мониторинг {#мониторинг}
...
### <span class="section-num">15.6</span> Железо {#железо}

-   [Формат Small Form-factor Pluggable (SFP)]({{< relref "2023-03-19-small-form-factor-pluggable" >}})


### <span class="section-num">15.7</span> Сервисы {#сервисы}


#### <span class="section-num">15.7.1</span> DNS {#dns}

-   [Domain Name System (DNS)]({{< relref "2023-09-16-domain-name-system-dns" >}})


#### <span class="section-num">15.7.2</span> Почта {#почта}

-   [Запросы по протоколу imap из командной строки]({{< relref "2024-04-13-imap-queries-command-line" >}})


## <span class="section-num">16</span> Организация обучения {#организация-обучения}

-   [Дисплейные классы]({{< relref "2021-09-26-computer-classes" >}})


## <span class="section-num">17</span> Профессиональные требования {#профессиональные-требования}
...
## <span class="section-num">18</span> DevOps {#devops}

-   [Непрерывная интеграция. GitHub Actions]({{< relref "2023-07-16-continuous-integration-github-actions" >}})


## <span class="section-num">19</span> Инфраструктура в РУДН {#инфраструктура-в-рудн}
