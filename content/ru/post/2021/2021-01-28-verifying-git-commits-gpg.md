...
lastmod: 2024-08-14T22:10:00+03:00
...
-   Для подписывания коммитов используется технология PGP (см. [Работа с PGP]({{< relref "2020-12-18-using-pgp" >}})) или ключи SSH (см. [Подпись коммитов git ключом ssh]({{< relref "2024-08-14-verifying-git-commits-ssh" >}})).
