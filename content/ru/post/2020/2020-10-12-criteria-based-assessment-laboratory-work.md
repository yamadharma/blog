...
lastmod: 2021-08-30T20:34:00+03:00
tags: ["education"]
categories: ["сиянс"]
draft: false
...
-   Будем исходить из 12 баллов за группу.


### <span class="section-num">3.1</span> Запись скринкаста (технические критерии) {#запись-скринкаста--технические-критерии}
...
| Скринкаст презентации | Отсутствует скринкаст | Скринкаст + голос без фиксирования вебкамерой | Скринкаст + голос с фиксированием вебкамерой |
...
| Структура    | Неструктурированный отчёта    | Слабоструктурированный отчёт                | Полностью соответствует структуре отчёта                    |
...
### <span class="section-num">3.3</span> Кода проекта (технические критерии) {#кода-проекта--технические-критерии}
...
### <span class="section-num">3.4</span> Выполнение соглашения об именовании лабораторной работы (технические критерии) {#выполнение-соглашения-об-именовании-лабораторной-работы--технические-критерии}
...
### <span class="section-num">3.5</span> Содержательная часть работы (содержательные критерии) {#содержательная-часть-работы--содержательные-критерии}
...
### <span class="section-num">3.6</span> Презентация о выполнении (содержательные критерии) {#презентация-о-выполнении--содержательные-критерии}
