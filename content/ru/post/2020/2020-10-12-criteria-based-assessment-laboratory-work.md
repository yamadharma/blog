...
lastmod: 2022-04-03T19:04:00+03:00
tags: ["education"]
categories: ["science"]
draft: false
...
-   Будем исходить из расчёта выделения 12 баллов за группу.
...
| Критерий                         | 0                     | 3                                          | 6                                         |
|----------------------------------|-----------------------|--------------------------------------------|-------------------------------------------|
| Скринкаст подготовки отчёта      | Отсутствует скринкаст | Скринкаст + голос, без фиксации вебкамерой | Скринкаст + голос, с фиксацией вебкамерой |
| Скринкаст подготовки презентации | Отсутствует скринкаст | Скринкаст + голос, без фиксации вебкамерой | Скринкаст + голос, с фиксацией вебкамерой |


### <span class="section-num">3.3</span> Отчёт о выполнении (технические критерии) {#отчёт-о-выполнении--технические-критерии}
...
### <span class="section-num">3.4</span> Код проекта (технические критерии) {#код-проекта--технические-критерии}
...
### <span class="section-num">3.6</span> Содержательная часть работы (содержательные критерии) {#содержательная-часть-работы--содержательные-критерии}
...
### <span class="section-num">3.7</span> Презентация о выполнении (содержательные критерии) {#презентация-о-выполнении--содержательные-критерии}
...
| Выступление с презентацией | Отсутствует                | Выступление путаное   | Свободное владение материалом |
