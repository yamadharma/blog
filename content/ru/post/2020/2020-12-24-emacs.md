...
lastmod: 2025-01-28T11:19:00+03:00
tags: ["emacs"]
...
### <span class="section-num">4.7</span> Чтение {#чтение}

-   [Emacs. Отложенное чтение. wallabag.el]({{< relref "2025-01-03--emacs-wallabagel" >}})


### <span class="section-num">4.8</span> Самоорганизация {#самоорганизация}
...
### <span class="section-num">4.9</span> Диаграммы {#диаграммы}

-   [Emacs. Диаграммы Ганта]({{< relref "2024-12-10-emacs-gantt-charts" >}})


### <span class="section-num">4.10</span> Файловая навигация {#файловая-навигация}

-   [Emacs. Пакет TRAMP]({{< relref "2024-06-29-emacs-tramp" >}})


### <span class="section-num">4.11</span> Языки разметки {#языки-разметки}


#### <span class="section-num">4.11.1</span> Легковесные языки разметки {#легковесные-языки-разметки}

-   [Org-mode]({{< relref "2021-10-14-org-mode" >}})


#### <span class="section-num">4.11.2</span> LaTeX {#latex}
