...
lastmod: 2023-10-11T15:47:00+03:00
tags: ["sysadmin"]
...
## <span class="section-num">5</span> Примеры скриптов развёртывания {#примеры-скриптов-развёртывания}


### <span class="section-num">5.1</span> Установка Rocky Linux 9.0 {#установка-rocky-linux-9-dot-0}
