...
lastmod: 2023-01-10T14:20:00+03:00
tags: ["apartment"]
categories: ["life"]
draft: false
...
## <span class="section-num">6</span> Оценка квартиры {#оценка-квартиры}

-   Для предоставления в банк необходимо сделать оценку квартиры.


### <span class="section-num">6.1</span> Основные документы {#основные-документы}
...
### <span class="section-num">6.2</span> Дополнительные Документы {#дополнительные-документы}

-   Для ипотеки (если ипотека оформлена в «Сбербанке», «ДОМ РФ», «Газпромбанке»):
    -   Кадастровый номер квартиры, его можно посмотреть на сайте Росреестра --- <https://rosreestr.gov.ru/>;
...
-   Выписка из ЕГРН «Об основных характеристиках и зарегистрированных правах», нужна:
    ...
    -   Заказать выписку можно в электронной форме на <https://rosreestr.gov.ru/>.
