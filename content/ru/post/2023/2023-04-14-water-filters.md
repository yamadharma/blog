...
lastmod: 2023-04-14T19:14:00+03:00
tags: ["apartment"]
categories: ["life"]
draft: false
slug: "water-filters"
...
## <span class="section-num">3</span> Варианты фильтров {#варианты-фильтров}


### <span class="section-num">3.1</span> Проточные фильтры {#проточные-фильтры}


#### <span class="section-num">3.1.1</span> Electrolux {#electrolux}
...
#### <span class="section-num">3.1.2</span> Барьер {#барьер}
...
#### <span class="section-num">3.1.3</span> Гейзер {#гейзер}

-   <https://shop.geizer.com/catalog/filtry_pod_moyku/geyzer_standart_dlya_zhestkoy_vody/>


#### <span class="section-num">3.1.4</span> Аквабрайт {#аквабрайт}

-   <https://aquabright.ru/ru/produktsiya/sistemy/abf-tria>


#### <span class="section-num">3.1.5</span> Bravo {#bravo}

-   <https://ita-filter.ru/filtry-pod-mojku/filtr-pod-mojku-bravo-trio-umyagchenie-1>


#### <span class="section-num">3.1.6</span> Аквафор {#аквафор}

-   <https://www.aquaphor.ru/filters/trio-h>


### <span class="section-num">3.2</span> Обратный осмос {#обратный-осмос}


#### <span class="section-num">3.2.1</span> Барьер {#барьер}
