...
## <span class="section-num">4</span> Windows {#windows}


### <span class="section-num">4.1</span> bug.n {#bug-dot-n}

-   Репозиторий: <https://github.com/fuhsjr00/bug.n>
-   Создан как скрипт AutoHotKey.


### <span class="section-num">4.2</span> MaxTo {#maxto}

-   Сайт: <https://maxto.net/>
-   Триальная версия


### <span class="section-num">4.3</span> Stack {#stack}

-   Сайт: <https://losttech.software/stack.html>


### <span class="section-num">4.4</span> Plumb {#plumb}

-   Сайт: <http://palatialsoftware.com/>


### <span class="section-num">4.5</span> workspacer {#workspacer}
...
### <span class="section-num">4.6</span> dwm-win32 {#dwm-win32}
