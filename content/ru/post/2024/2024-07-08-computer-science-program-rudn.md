...
lastmod: 2024-07-22T21:28:00+03:00
tags: ["rudn", "education"]
...
### <span class="section-num">8.2</span> Специфика научного программного обеспечения {#специфика-научного-программного-обеспечения}

-   Научное ПО имеет ряд особенностей, которые не встречаются в коммерческом ПО.


#### <span class="section-num">8.2.1</span> Используемые алгоритмы крайне сложны {#используемые-алгоритмы-крайне-сложны}

-   Зачастую в них разбирается очень узкая группа людей.


#### <span class="section-num">8.2.2</span> Низкая универсальность {#низкая-универсальность}

-   Всё, что можно было сделать стандартными методами, уже давно сделано.


#### <span class="section-num">8.2.3</span> Уникальная модель распространения {#уникальная-модель-распространения}
...
#### <span class="section-num">8.2.4</span> Остаточное финансирование {#остаточное-финансирование}
...
#### <span class="section-num">8.2.5</span> Учёный --- не программист {#учёный-не-программист}
...
#### <span class="section-num">8.2.6</span> Унаследованный код (legacy) {#унаследованный-код--legacy}
...
#### <span class="section-num">8.2.7</span> Фрагментация разработки {#фрагментация-разработки}
...
#### <span class="section-num">8.2.8</span> Сложность отладки и тестирования {#сложность-отладки-и-тестирования}
...
#### <span class="section-num">8.2.9</span> Требования к пользователям {#требования-к-пользователям}
...
#### <span class="section-num">8.2.10</span> Идеология DevOps {#идеология-devops}

-   Приходится не только разрабатывать программное обеспечение, но и поддерживать инфраструктуру.


### <span class="section-num">8.3</span> Предлагаемые треки {#предлагаемые-треки}
...
### <span class="section-num">9.6</span> Моделирование (ТМО) {#моделирование--тмо}


### <span class="section-num">9.7</span> Моделирование (Сети) {#моделирование--сети}

-


### <span class="section-num">9.8</span> Моделирование (Физические модели) {#моделирование--физические-модели}
