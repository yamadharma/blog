...
-   Обычно диссертации придерживаются структуры IMRAD (см. [Структура IMRAD]({{< relref "../notes/public/20240105192200-структура_imrad.md" >}})).
...
-   Используется стандартная структура статьи (см. [Структура исследовательской статьи]({{< relref "../notes/public/20250528T154800--структура_исследовательскои_статьи.md" >}})).
