...
lastmod: 2024-04-25T22:34:00+03:00
...
## <span class="section-num">3</span> Привязка клавиш по умолчанию {#привязка-клавиш-по-умолчанию}


### <span class="section-num">3.1</span> Открытие файлов {#открытие-файлов}
...
### <span class="section-num">3.2</span> Перемещение {#перемещение}
...
### <span class="section-num">3.3</span> Масштабирование {#масштабирование}
...
### <span class="section-num">3.4</span> Навигация по истории {#навигация-по-истории}
...
### <span class="section-num">3.5</span> Обзор {#обзор}
...
### <span class="section-num">3.6</span> Визуальная метка {#визуальная-метка}
...
### <span class="section-num">3.7</span> Поиск {#поиск}
...
### <span class="section-num">3.8</span> Метки {#метки}
...
### <span class="section-num">3.9</span> Закладки {#закладки}
...
### <span class="section-num">3.10</span> Выделения {#выделения}
...
### <span class="section-num">3.11</span> Порталы {#порталы}
...
### <span class="section-num">3.12</span> Командное меню {#командное-меню}

-   Меню команд можно открыть, нажав `:` (`command`).
-   Это доступный для поиска список всех команд, а также их текущие сочетания клавиш.


### <span class="section-num">3.13</span> Внешний поиск {#внешний-поиск}
...
### <span class="section-num">3.14</span> SyncTeX {#synctex}
...
### <span class="section-num">3.15</span> Данные и синхронизация {#данные-и-синхронизация}
...
### <span class="section-num">3.16</span> Конфигурация окна {#конфигурация-окна}
