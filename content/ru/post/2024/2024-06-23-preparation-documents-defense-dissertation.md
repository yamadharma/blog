...
lastmod: 2024-06-23T16:01:00+03:00
tags: ["education"]
categories: ["science"]
draft: false
...
## <span class="section-num">2</span> Первичный пакет документов для отправки в ДАНК {#первичный-пакет-документов-для-отправки-в-данк}
...
## <span class="section-num">3</span> Принятие к рассмотрению {#принятие-к-рассмотрению}

-   [ ] Список членов экспертной комиссии


## <span class="section-num">4</span> После принятия к рассмотрению {#после-принятия-к-рассмотрению}

-   [ ] Протокол принятия к рассмотрению


## <span class="section-num">5</span> Принятие к защите {#принятие-к-защите}
...
## <span class="section-num">6</span> После заседания по принятию к защите {#после-заседания-по-принятию-к-защите}
