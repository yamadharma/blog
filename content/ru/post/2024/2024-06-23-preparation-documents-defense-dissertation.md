...
lastmod: 2024-09-13T20:07:00+03:00
tags: ["education"]
categories: ["science"]
draft: false
...
### <span class="section-num">3.1</span> Первичный пакет документов для отправки в ДАНК {#первичный-пакет-документов-для-отправки-в-данк}


#### <span class="section-num">3.1.1</span> Куда отправлять первый пакет документов {#куда-отправлять-первый-пакет-документов}
...
#### <span class="section-num">3.1.2</span> После приёма документов ДАНК {#после-приёма-документов-данк}
...
#### <span class="section-num">3.1.3</span> Чек-лист для первичного пакета документов {#чек-лист-для-первичного-пакета-документов}
...
#### <span class="section-num">3.1.4</span> Комментарии к документам {#комментарии-к-документам}
...
### <span class="section-num">3.2</span> Принятие к рассмотрению {#принятие-к-рассмотрению}
...
#### <span class="section-num">3.2.2</span> Чек-лист для документов для принятия к рассмотрению {#чек-лист-для-документов-для-принятия-к-рассмотрению}
...
### <span class="section-num">3.3</span> После принятия к рассмотрению {#после-принятия-к-рассмотрению}
...
#### <span class="section-num">3.3.2</span> Чек-лист для документов после принятия к рассмотрению {#чек-лист-для-документов-после-принятия-к-рассмотрению}
...
### <span class="section-num">3.4</span> Принятие к защите {#принятие-к-защите}
...
#### <span class="section-num">3.4.2</span> Чек-лист для документов по принятию к защите {#чек-лист-для-документов-по-принятию-к-защите}
...
### <span class="section-num">3.5</span> После заседания по принятию к защите {#после-заседания-по-принятию-к-защите}
...
#### <span class="section-num">3.5.2</span> Чек-лист для документов после принятия к защите {#чек-лист-для-документов-после-принятия-к-защите}
