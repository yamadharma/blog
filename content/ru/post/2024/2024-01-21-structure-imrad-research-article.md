...
-   Для естественнонаучных исследований фактическим стандартом построения письменной работы является IMRAD (см. [Структура IMRAD]({{< relref "../notes/public/20240105192200-структура_imrad.md" >}})).
-   Это уровень синтаксиса (см. [Синтаксис, семантика, прагматика]({{< relref "../notes/public/20230508163200-синтаксис_семантика_прагматика.md" >}})).
-   Данный стиль характеризуется превалированием низкого контекста перед высоким в научных исследованиях (см. [Высокий и низкий контекст]({{< relref "../notes/public/20250525T210400--высокии_и_низкии_контекст.md" >}})).
...
-   [Структура аннотации]({{< relref "../notes/public/20210222163800-структура_аннотации.md" >}})
...
-   [DCM. Авторская этика]({{< relref "../notes/public/20240810213200-dcm_авторская_этика.md" >}})
...
1.  Вклад авторов
    ...
    -   [Роли авторов научной работы]({{< relref "../notes/public/20240121200700-роли_авторов_научнои_работы.md" >}})
