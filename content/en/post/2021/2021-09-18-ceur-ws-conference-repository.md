...
### <span class="section-num">2.1</span> Workshop {#workshop}

-   Conference proceedings can only be accepted as an exception, e.g.
    -   if they have a long history with CEUR-WS;
    -   they made a prior agreement with CEUR-WS.
-   There are some event that label themselves conferences but have more the size of a workshop, i.e. 20 or less papers.
    -   CEUR-WS does not see a problem to accept such submission, even though the organizers should be advised to call the event a workshop in the future.


### <span class="section-num">2.2</span> Computer science {#computer-science}
...
### <span class="section-num">2.3</span> English {#english}
...
## <span class="section-num">5</span> Mathematical modeling {#mathematical-modeling}
